...
public class ItemAnchovyBucket extends EntityBucketItem {

    public static final String ITEM_ID = "anchovy_bucket";

    public ItemAnchovyBucket() {
        super(ModEntityHandler.ANCHOVY,
                Fluids.WATER,
        ...
        MurkysManyFish.LOGGER.info("Building Anchovy Bucket");
    }
}