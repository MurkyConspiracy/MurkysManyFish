...
import com.disruptioncomplex.entity.client.BettaVariant;
...
public class BettaEntity extends SchoolingFishEntity {
    ...
    VARIANT
     */
    private static final TrackedData<Integer> BETTA_VARIANT =
    ...
    public BettaEntity(EntityType<? extends SchoolingFishEntity> entityType, World world) {
        ...
        this.setVariant(this.random.nextInt(100) == 0 ? BettaVariant.PRIDE : BettaVariant.DEFAULT);
    }
    ...
    public ItemStack getBucketItem() {
        return new ItemStack(ModItemHandler.BETTA_BUCKET);
    }
    ...
    private int getTypeVariant() {
        return this.dataTracker.get(BETTA_VARIANT);
    }

    public void setVariant(BettaVariant variant) {
        this.dataTracker.set(BETTA_VARIANT, variant.getId());
    }
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Variant")) {
            this.dataTracker.set(BETTA_VARIANT, nbt.getInt("Variant").orElse(0));
        }
    }
    ...
    public @Nullable EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        BettaVariant variant = world.getRandom().nextInt(100) == 1 ? BettaVariant.PRIDE : BettaVariant.DEFAULT;
        setVariant(variant);
